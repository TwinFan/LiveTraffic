...
// >>> Some definitons _copied_ from Include/TextIO.h so that we don't need to include all the LiveTraffic header stack <<<
// Log Text to log file
void LogFatalMsg ( const char* szPath, int ln, const char* szFunc, const char* szMsg, ... );
// Log a message then actually fail with assert()
